      ...
      <div className="  border rounded-xl shadow">
        ...
        <div className="h-[47rem] bg-gray-100 overflow-auto">
          <div className=" flex flex-row p-8 gap-4 ">
            ...
            <div className="  max-w-[500px] border rounded-b-lg rounded-tr-lg h-full min-h-[100px] w-auto  bg-white p-2 mx-2 break-words  ">
              <span>
          ...
          <div className="w-full flex justify-end p-4 max-w-[7000px] ">
            <div className=" border rounded-b-lg rounded-tl-lg h-full max-h-auto w-full p-2 bg-blue-500 text-white max-w-[30rem] break-words ">
              dsasssssssssssssssddsads placeat non dignissimos repellat fugit?
              Asperiores rerum enim nobis, autem qui dolorem architecto
              blanditiis dolores earum quod sequi voluptates. Placeat
              dignissimos et perferendis adipisci? Cupiditate ab laborum at
              suscipit voluptates! Error in fugit autem animi pariatur tempore
              ducimus, accusantium molestias accusamus exercitationem ratione
              placeat asperiores quam. Rerum nobis commodi, possimus explicabo
              quasi molestiae, placeat non dignissimos repellat fugit?
              Asperiores rerum enim
              
            </div>
          </div>
